      ...
      >
        ...
        >
          <Editor
            ...
            onMount={(editor) => {
              editor.focus();
              // Only block the specific keys ReactFlow hijacks.
              // Space = pan mode, Escape = deselect, Backspace/Delete = delete node
        ...
        >
          <ReactFlowProvider>
            <ReactFlow
              ...
              minZoom={0.3}
              maxZoom={2.5}
              // Disable ALL built-in keyboard shortcuts so Space/arrows
              // never get hijacked from the Monaco editor next to it
